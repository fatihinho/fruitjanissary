...
public class Lemon extends Fruit {
    ...
    public void update() {
        Game.score.setText(Game.addScore(20));

        InputStream inStream = getClass().getResourceAsStream("img/lemon.jpg");
    ...
    public void drawAndSlice() {
        ...
        Utils.translateTransitionCircleL(circle);
